        ...
        {projects.map((project) => (
          <motion.article variants={fadeUp} key={project.title} className="group">
            <a
              ...
              className="project-card block border border-ink/10 bg-white/55 transition duration-300 hover:shadow-[0_24px_70px_rgba(20,20,20,0.13)]"
            >
              <div className="project-media relative aspect-[4/3] overflow-hidden bg-mist">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
